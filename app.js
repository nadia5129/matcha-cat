...
app.post('/submit', async (req, res) => {
    try {
        ...
        // FIX: was using = instead of : for object properties, and wrong field names
        const submission = {
...
// GET /admin-create-an-account - fetch all accounts from DB
app.get('/admin-create-an-account', async (req, res) => {
    try {
        const [submissions] = await pool.execute('SELECT * FROM accounts');
